...
@implementation MockModelController
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    if (self.useZumeroStore) {
        self.store = [_persistentStoreCoordinator addPersistentStoreWithType:[MockIncrementalStore type]
                                                               configuration:nil
                                                                         URL:nil
                                                                     options:options
                                                                       error:&error];
    } else {
        NSURL *storeURL = [[NSFileManager applicationDocumentsDirectory] URLByAppendingPathComponent:@"ZumeroTest.sqlite"];
